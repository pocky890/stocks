"""研究用一次性腳本：比較chip_momentum(外資買超動能)現行的「連續剛好3天買超」進場條件
vs 使用者提出的「近10日外資累積買超為正，且近3日內至少2日買超」新條件，全觀察清單10年
+2026 YTD/7月回測比較，不動STRATEGY_REGISTRY的預設params。"""
import sys
...
CONFIGS = [
    ("原本(連續剛好3天)", {}),
    ("新條件(近10日累積為正+近3日至少2日買超)", {"entry_mode": "window"}),
]
